...
public class PhasedEtherealPickaxeItem extends PickaxeItem {
	...
	public PhasedEtherealPickaxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 7f, -1.6f)).fireResistant());
	}
