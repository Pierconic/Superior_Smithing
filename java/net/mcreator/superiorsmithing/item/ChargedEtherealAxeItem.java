...
public class ChargedEtherealAxeItem extends AxeItem {
	...
	public ChargedEtherealAxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 14f, -2.4f)).fireResistant());
	}
