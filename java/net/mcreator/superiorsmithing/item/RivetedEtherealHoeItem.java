...
public class RivetedEtherealHoeItem extends HoeItem {
	...
	public RivetedEtherealHoeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 3f, -1.6f)).fireResistant());
	}
