...
public class ChargedIronShovelItem extends ShovelItem {
	...
	public ChargedIronShovelItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 6f, -2.6f)));
	}
