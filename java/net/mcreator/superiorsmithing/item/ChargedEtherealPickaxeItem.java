...
public class ChargedEtherealPickaxeItem extends PickaxeItem {
	...
	public ChargedEtherealPickaxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 9f, -2.2f)).fireResistant());
	}
