...
public abstract class EchoingLeatherArmorItem extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 3);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorsmithing:aechoingleatherarmor_"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("superiorsmithing:echoing_leather_armor"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public EchoingLeatherArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends EchoingLeatherArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends EchoingLeatherArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends EchoingLeatherArmorItem {
		public Leggings() {
	...
	public static class Boots extends EchoingLeatherArmorItem {
		public Boots() {
