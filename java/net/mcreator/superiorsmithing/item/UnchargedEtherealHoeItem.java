...
public class UnchargedEtherealHoeItem extends HoeItem {
	...
	public UnchargedEtherealHoeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 1f, -1.6f)).fireResistant());
	}
