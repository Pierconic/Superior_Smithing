...
public abstract class UnchargedNetheriteArmorItem extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 6);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorsmithing:aunchargednetheritearmor_"))), 2f, 0.1f);
			registerHelper.register(ResourceLocation.parse("superiorsmithing:uncharged_netherite_armor"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public UnchargedNetheriteArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends UnchargedNetheriteArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends UnchargedNetheriteArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends UnchargedNetheriteArmorItem {
		public Leggings() {
	...
	public static class Boots extends UnchargedNetheriteArmorItem {
		public Boots() {
