...
public class ChargedIronAxeItem extends AxeItem {
	...
	public ChargedIronAxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 10f, -2.9f)));
	}
