...
public class ReinforcedShieldItem extends ShieldItem {
	public ReinforcedShieldItem() {
		super(new Item.Properties().durability(460));
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal(("\u00A72") + " 2 Defense"));
		list.add(Component.literal(("\u00A72") + " x0.3 Recovery Speed"));
		list.add(Component.literal(("\u00A72") + " 4.0s Break Recovery"));
	}
