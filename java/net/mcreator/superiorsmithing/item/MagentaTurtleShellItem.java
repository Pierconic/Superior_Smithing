...
public abstract class MagentaTurtleShellItem extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 0);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorsmithing:turtlearmormagenta_"))), 0.5f, 0f);
			registerHelper.register(ResourceLocation.parse("superiorsmithing:magenta_turtle_shell"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public MagentaTurtleShellItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends MagentaTurtleShellItem {
		public Helmet() {
