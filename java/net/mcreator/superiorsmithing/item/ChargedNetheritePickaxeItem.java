...
public class ChargedNetheritePickaxeItem extends PickaxeItem {
	...
	public ChargedNetheritePickaxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 7f, -2.6f)).fireResistant());
	}
