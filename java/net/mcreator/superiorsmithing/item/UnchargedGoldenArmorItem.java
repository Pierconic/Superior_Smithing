...
public abstract class UnchargedGoldenArmorItem extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 3);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorsmithing:aunchargedgoldarmor_"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("superiorsmithing:uncharged_golden_armor"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public UnchargedGoldenArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends UnchargedGoldenArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends UnchargedGoldenArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends UnchargedGoldenArmorItem {
		public Leggings() {
	...
	public static class Boots extends UnchargedGoldenArmorItem {
		public Boots() {
