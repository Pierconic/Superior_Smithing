...
public class ConchedEtherealAxeItem extends AxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(Items.NETHER_STAR), new ItemStack(Items.NAUTILUS_SHELL));
		}
	};

	public ConchedEtherealAxeItem() {
