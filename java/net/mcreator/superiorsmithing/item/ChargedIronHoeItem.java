...
public class ChargedIronHoeItem extends HoeItem {
	...
	public ChargedIronHoeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 2f, 0f)));
	}
