...
public abstract class PinkTurtleShellItem extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 0);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorsmithing:turtlearmorpink_"))), 0.5f, 0f);
			registerHelper.register(ResourceLocation.parse("superiorsmithing:pink_turtle_shell"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public PinkTurtleShellItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends PinkTurtleShellItem {
		public Helmet() {
