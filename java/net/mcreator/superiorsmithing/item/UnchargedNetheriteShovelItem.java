...
public class UnchargedNetheriteShovelItem extends ShovelItem {
	...
	public UnchargedNetheriteShovelItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 4f, -3.2f)).fireResistant());
	}
