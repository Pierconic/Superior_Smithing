...
public abstract class UnchargedLeatherArmorItem extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 2);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorsmithing:aunchargedleatherarmor_"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("superiorsmithing:uncharged_leather_armor"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public UnchargedLeatherArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends UnchargedLeatherArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends UnchargedLeatherArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends UnchargedLeatherArmorItem {
		public Leggings() {
	...
	public static class Boots extends UnchargedLeatherArmorItem {
		public Boots() {
