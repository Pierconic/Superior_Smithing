...
public class UnchargedDiamondSwordItem extends SwordItem {
	...
	public UnchargedDiamondSwordItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 2f, -2.8f)));
	}
