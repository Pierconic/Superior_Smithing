...
public class PhasedEtherealAxeItem extends AxeItem {
	...
	public PhasedEtherealAxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 11f, -1.6f)).fireResistant());
	}
