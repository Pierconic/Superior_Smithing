...
public class RivetedEtherealAxeItem extends AxeItem {
	...
	public RivetedEtherealAxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 12f, -3f)).fireResistant());
	}
