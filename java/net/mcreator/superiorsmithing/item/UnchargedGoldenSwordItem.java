...
public class UnchargedGoldenSwordItem extends SwordItem {
	...
	public UnchargedGoldenSwordItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 0f, -2.7f)));
	}
