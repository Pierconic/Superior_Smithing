...
public class MysticGoldenPickaxeItem extends PickaxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(Items.GOLD_INGOT), new ItemStack(Items.LAPIS_LAZULI));
		}
	};

	public MysticGoldenPickaxeItem() {
