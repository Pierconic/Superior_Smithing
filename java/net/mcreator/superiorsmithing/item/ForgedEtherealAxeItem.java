...
public class ForgedEtherealAxeItem extends AxeItem {
	...
	public ForgedEtherealAxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 13f, -2.8f)).fireResistant());
	}
