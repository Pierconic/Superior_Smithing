...
public class UnchargedGoldenPickaxeItem extends PickaxeItem {
	...
	public UnchargedGoldenPickaxeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 0f, -3.2f)));
	}
