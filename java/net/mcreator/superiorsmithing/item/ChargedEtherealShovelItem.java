...
public class ChargedEtherealShovelItem extends ShovelItem {
	...
	public ChargedEtherealShovelItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 10f, -2.6f)).fireResistant());
	}
