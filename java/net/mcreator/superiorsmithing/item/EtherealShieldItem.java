...
public class EtherealShieldItem extends ShieldItem {
	public EtherealShieldItem() {
		super(new Item.Properties().durability(944).fireResistant());
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal(("\u00A72") + " 7 Defense"));
		list.add(Component.literal(("\u00A72") + " x0.2 Recovery Speed"));
		list.add(Component.literal(("\u00A72") + " 2.0s Break Recovery"));
	}
