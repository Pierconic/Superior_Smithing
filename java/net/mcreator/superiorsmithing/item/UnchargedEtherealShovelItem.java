...
public class UnchargedEtherealShovelItem extends ShovelItem {
	...
	public UnchargedEtherealShovelItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 6f, -3.2f)).fireResistant());
	}
