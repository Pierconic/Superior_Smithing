...
public class ShelledNetheritePickaxeItem extends PickaxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(Items.NETHERITE_INGOT), new ItemStack(Items.SHULKER_SHELL));
		}
	};

	public ShelledNetheritePickaxeItem() {
