...
public class ChargedEtherealHoeItem extends HoeItem {
	...
	public ChargedEtherealHoeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 5f, 1f)).fireResistant());
	}
