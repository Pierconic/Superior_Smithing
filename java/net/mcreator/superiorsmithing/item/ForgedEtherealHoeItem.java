...
public class ForgedEtherealHoeItem extends HoeItem {
	...
	public ForgedEtherealHoeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 4f, 0f)).fireResistant());
	}
