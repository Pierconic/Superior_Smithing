...
public class UnchargedEtherealSwordItem extends SwordItem {
	...
	public UnchargedEtherealSwordItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 3f, -2.7f)).fireResistant());
	}
