...
public class ForgedShieldItem extends ShieldItem {
	public ForgedShieldItem() {
		super(new Item.Properties().durability(644).fireResistant());
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal(("\u00A72") + " 6 Defense"));
		list.add(Component.literal(("\u00A72") + " x0.6 Recovery Speed"));
		list.add(Component.literal(("\u00A72") + " 7.0s Break Recovery"));
	}
