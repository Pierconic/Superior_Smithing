...
public class EchoingDiamondPickaxeItem extends PickaxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(Items.DIAMOND), new ItemStack(Items.ECHO_SHARD));
		}
	};

	public EchoingDiamondPickaxeItem() {
