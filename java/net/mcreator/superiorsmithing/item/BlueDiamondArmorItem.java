		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 8);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("superiorsmithing:diamondarmorblue_"))), 2.5f, 0f);
			registerHelper.register(ResourceLocation.parse("superiorsmithing:blue_diamond_armor"), armorMaterial);
