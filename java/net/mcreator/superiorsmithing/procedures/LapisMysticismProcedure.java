...
public class LapisMysticismProcedure {
	public static void execute(Entity entity) {
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:leather_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_LEATHER_ARMOR_HELMET.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_LEATHER_ARMOR_CHESTPLATE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_LEATHER_ARMOR_LEGGINGS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_LEATHER_ARMOR_BOOTS.get()).copy();
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:chainmail_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_CHAINMAIL_ARMOR_HELMET.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_CHAINMAIL_ARMOR_CHESTPLATE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_CHAINMAIL_ARMOR_LEGGINGS.get()).copy();
			if (!(target.getDisplayName().getString()).equals("[" + Component.translatable("item.minecraft.chainmail_leggings").getString() + "]")) {
				ItemName = target.getDisplayName().getString();
				product.set(DataComponents.CUSTOM_NAME, Component.literal(((ItemName.replace("[", "")).replace("]", ""))));
			}
		} else if (target.is(ItemTags.create(ResourceLocation.parse("forge:chainmail_leggings")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_CHAINMAIL_ARMOR_BOOTS.get()).copy();
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:iron_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_ARMOR_HELMET.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_ARMOR_CHESTPLATE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_ARMOR_LEGGINGS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_ARMOR_BOOTS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_SWORD.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_SHOVEL.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_PICKAXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_AXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_IRON_HOE.get()).copy();
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:golden_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_ARMOR_HELMET.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_ARMOR_CHESTPLATE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_ARMOR_LEGGINGS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_ARMOR_BOOTS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_SWORD.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_SHOVEL.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_PICKAXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_AXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_GOLDEN_HOE.get()).copy();
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:diamond_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_ARMOR_HELMET.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_ARMOR_CHESTPLATE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_ARMOR_LEGGINGS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_ARMOR_BOOTS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_SWORD.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_SHOVEL.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_PICKAXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_AXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_DIAMOND_HOE.get()).copy();
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:netherite_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_ARMOR_HELMET.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_ARMOR_CHESTPLATE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_ARMOR_LEGGINGS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_ARMOR_BOOTS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_SWORD.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_SHOVEL.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_PICKAXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_AXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_NETHERITE_HOE.get()).copy();
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:turtle_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_TURTLE_SHELL_HELMET.get()).copy();
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:ethereal_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_ARMOR_HELMET.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_ARMOR_CHESTPLATE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_ARMOR_LEGGINGS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_ARMOR_BOOTS.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_SWORD.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_SHOVEL.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_PICKAXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_AXE.get()).copy();
			...
			product = new ItemStack(SuperiorsmithingModItems.MYSTIC_ETHEREAL_HOE.get()).copy();
