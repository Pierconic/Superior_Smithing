...
public class DisplayChargingProcedure {
	public static boolean execute(Entity entity) {
		...
		}.hasRecipe(entity, ResourceLocation.parse("superiorsmithing:charged_template_recipe")) && entity.getData(SuperiorsmithingModVariables.PLAYER_VARIABLES).SmithingRecipeBook == true
				&& entity.getData(SuperiorsmithingModVariables.PLAYER_VARIABLES).SmithingRecipePage == 5) {
			return true;
		}
		return false;
	}
