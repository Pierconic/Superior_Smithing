...
public class RedstoneChargingProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:chainmail_helmet")))) {
		...
		} else if (target.is(ItemTags.create(ResourceLocation.parse("forge:chainmail_chestplate")))) {
		...
		} else if (target.is(ItemTags.create(ResourceLocation.parse("forge:ethereal_axe")))) {
		...
		} else if (target.is(ItemTags.create(ResourceLocation.parse("forge:ethereal_hoe")))) {
