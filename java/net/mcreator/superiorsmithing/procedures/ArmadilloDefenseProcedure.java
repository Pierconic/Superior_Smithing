...
@EventBusSubscriber
public class ArmadilloDefenseProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (sourceentity instanceof LivingEntity) {
			if (SuperiorsmithingModItems.ARMADILLO_SHELL_HELMET.get() == (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem()) {
				if (entity instanceof LivingEntity _livEnt3 && _livEnt3.hasEffect(MobEffects.DAMAGE_RESISTANCE)) {
					...
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
							_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.armadillo.hurt")), SoundSource.NEUTRAL, 1, 1);
						} else {
							_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.armadillo.hurt")), SoundSource.NEUTRAL, 1, 1, false);
						}
					}
					SuperiorsmithingMod.queueServerWork(5, () -> {
