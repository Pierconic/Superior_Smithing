...
public class DisplayUpgrade2Procedure {
	public static boolean execute(Entity entity) {
		...
		}.hasRecipe(entity, ResourceLocation.parse("superiorsmithing:ethereal_template_recipe")) && entity.getData(SuperiorsmithingModVariables.PLAYER_VARIABLES).SmithingRecipeBook == true
				&& entity.getData(SuperiorsmithingModVariables.PLAYER_VARIABLES).SmithingRecipePage == 13) {
			return true;
		}
		return false;
	}
