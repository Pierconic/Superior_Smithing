...
@EventBusSubscriber
public class DrownedEquipmentProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double rarity = 0;
		if (entity instanceof Drowned && !(entity.getDisplayName().getString()).equals("static")) {
			...
			if (weapon == true) {
				if (rarity == 0) {
					type = Mth.nextInt(RandomSource.create(), 0, 6);
					if (type == 0) {
						if (entity instanceof LivingEntity _entity) {
						...
						if (entity instanceof LivingEntity _entity) {
							ItemStack _setstack = new ItemStack(Items.NAUTILUS_SHELL).copy();
							_setstack.setCount(1);
							_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
							if (_entity instanceof Player _player)
								_player.getInventory().setChanged();
					...
					if (weaponmodified == true) {
						if (weaponenchanted == true) {
							if (type == 0) {
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(Items.FISHING_ROD), Mth.nextInt(RandomSource.create(), 10, 20),
											(false)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_HOE.get()), Mth.nextInt(RandomSource.create(), 10, 20),
											(false)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
							...
							if (type == 0) {
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_SWORD.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_SHOVEL.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_PICKAXE.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_HOE.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
					...
					if (weaponmodified == true) {
						if (weaponenchanted == true) {
							if (type == 1) {
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_SWORD.get()), Mth.nextInt(RandomSource.create(), 10, 20),
											(true)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_GOLDEN_SHOVEL.get()), Mth.nextInt(RandomSource.create(), 10, 20),
											(true)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_GOLDEN_PICKAXE.get()), Mth.nextInt(RandomSource.create(), 10, 20),
											(true)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_HOE.get()), Mth.nextInt(RandomSource.create(), 10, 20),
											(true)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
							...
							if (type == 0) {
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_SWORD.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_SHOVEL.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_PICKAXE.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(SuperiorsmithingModItems.REINFORCED_GOLDEN_HOE.get()).copy();
									_setstack.setCount(1);
									_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
									if (_entity instanceof Player _player)
										_player.getInventory().setChanged();
					...
					if (weaponmodified == true) {
						if (weaponenchanted == true) {
							if (type == 0) {
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_SWORD.get()), Mth.nextInt(RandomSource.create(), 10, 20),
											(true)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(Items.TRIDENT), Mth.nextInt(RandomSource.create(), 10, 20),
											(true)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
				...
				if (rarity == 0) {
					{
						Entity _entity = entity;
						if (_entity instanceof Player _player) {
							_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_HELMET.get()));
							_player.getInventory().setChanged();
						} else if (_entity instanceof LivingEntity _living) {
							_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_HELMET.get()));
						}
					}
				} else if (rarity == 1) {
					if (armormodified == true) {
						if (armorenchanted == true) {
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_HELMET.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_HELMET.get()));
								}
							}
						}
					...
					if (Math.random() < 0.5) {
						if (armormodified == true) {
							if (armorenchanted == true) {
								{
									...
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(3,
												(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_TURTLE_SHELL_HELMET.get()), Mth.nextInt(RandomSource.create(), 10, 20),
														(true)
																? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
																: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
										_player.getInventory().setChanged();
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.REINFORCED_TURTLE_SHELL_HELMET.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.REINFORCED_TURTLE_SHELL_HELMET.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
							{
								...
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(3,
											(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(Items.TURTLE_HELMET), Mth.nextInt(RandomSource.create(), 10, 20),
													(true)
															? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
															: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
									_player.getInventory().setChanged();
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.CONCHED_TURTLE_SHELL_HELMET.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.CONCHED_TURTLE_SHELL_HELMET.get()));
								}
							}
						}
					} else {
							...
							if (armorenchanted == true) {
								{
									...
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(3,
												(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_CHAINMAIL_ARMOR_HELMET.get()), Mth.nextInt(RandomSource.create(), 10, 20),
														(true)
																? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
																: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
										_player.getInventory().setChanged();
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_HELMET.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_HELMET.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
						...
						if (armorenchanted == true) {
							{
								...
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(3,
											(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_DIAMOND_ARMOR_HELMET.get()), Mth.nextInt(RandomSource.create(), 10, 20),
													(true)
															? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
															: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
									_player.getInventory().setChanged();
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_HELMET.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_HELMET.get()));
								}
							}
						}
					} else if (armorenchanted == true) {
				...
				if (rarity == 0) {
					{
						Entity _entity = entity;
						if (_entity instanceof Player _player) {
							_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_CHESTPLATE.get()));
							_player.getInventory().setChanged();
						} else if (_entity instanceof LivingEntity _living) {
							_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_CHESTPLATE.get()));
						}
					}
				} else if (rarity == 1) {
					if (armormodified == true) {
						if (armorenchanted == true) {
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_CHESTPLATE.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_CHESTPLATE.get()));
								}
							}
						}
					} else if (armorenchanted == true) {
							...
							if (armorenchanted == true) {
								{
									...
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(2,
												(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_GOLDEN_ARMOR_CHESTPLATE.get()), Mth.nextInt(RandomSource.create(), 10, 20),
														(true)
																? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
																: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
										_player.getInventory().setChanged();
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_ARMOR_CHESTPLATE.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_ARMOR_CHESTPLATE.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
							...
							if (armorenchanted == true) {
								{
									...
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(2,
												(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_CHAINMAIL_ARMOR_CHESTPLATE.get()), Mth.nextInt(RandomSource.create(), 10, 20),
														(true)
																? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
																: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
										_player.getInventory().setChanged();
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_CHESTPLATE.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_CHESTPLATE.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
						...
						if (armorenchanted == true) {
							{
								...
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(2,
											(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_DIAMOND_ARMOR_CHESTPLATE.get()), Mth.nextInt(RandomSource.create(), 20, 30),
													(true)
															? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
															: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
									_player.getInventory().setChanged();
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_CHESTPLATE.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_CHESTPLATE.get()));
								}
							}
						}
					} else if (armorenchanted == true) {
				...
				if (rarity == 0) {
					{
						Entity _entity = entity;
						if (_entity instanceof Player _player) {
							_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_LEGGINGS.get()));
							_player.getInventory().setChanged();
						} else if (_entity instanceof LivingEntity _living) {
							_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_LEGGINGS.get()));
						}
					}
				} else if (rarity == 1) {
					if (armormodified == true) {
						if (armorenchanted == true) {
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_LEGGINGS.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_LEGGINGS.get()));
								}
							}
						}
					} else if (armorenchanted == true) {
							...
							if (armorenchanted == true) {
								{
									...
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(1,
												(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_GOLDEN_ARMOR_LEGGINGS.get()), Mth.nextInt(RandomSource.create(), 10, 20),
														(true)
																? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
																: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
										_player.getInventory().setChanged();
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_ARMOR_LEGGINGS.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_ARMOR_LEGGINGS.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
							...
							if (armorenchanted == true) {
								{
									...
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(1,
												(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_CHAINMAIL_ARMOR_LEGGINGS.get()), Mth.nextInt(RandomSource.create(), 10, 20),
														(true)
																? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
																: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
										_player.getInventory().setChanged();
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_LEGGINGS.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_LEGGINGS.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
						...
						if (armorenchanted == true) {
							{
								...
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(1,
											(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_DIAMOND_ARMOR_LEGGINGS.get()), Mth.nextInt(RandomSource.create(), 20, 30),
													(true)
															? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
															: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
									_player.getInventory().setChanged();
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_LEGGINGS.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_LEGGINGS.get()));
								}
							}
						}
					} else if (armorenchanted == true) {
				...
				if (rarity == 0) {
					{
						Entity _entity = entity;
						if (_entity instanceof Player _player) {
							_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_BOOTS.get()));
							_player.getInventory().setChanged();
						} else if (_entity instanceof LivingEntity _living) {
							_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.BLUE_LEATHER_ARMOR_BOOTS.get()));
						}
					}
				} else if (rarity == 1) {
					if (armormodified == true) {
						if (armorenchanted == true) {
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_BOOTS.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.CONCHED_IRON_ARMOR_BOOTS.get()));
								}
							}
						}
					} else if (armorenchanted == true) {
							...
							if (armorenchanted == true) {
								{
									...
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(0,
												(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_GOLDEN_ARMOR_BOOTS.get()), Mth.nextInt(RandomSource.create(), 10, 20),
														(true)
																? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
																: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
										_player.getInventory().setChanged();
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_ARMOR_BOOTS.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.CONCHED_GOLDEN_ARMOR_BOOTS.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
						...
						if (armormodified == true) {
							if (armorenchanted == true) {
							...
							} else {
								{
									Entity _entity = entity;
									if (_entity instanceof Player _player) {
										_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_BOOTS.get()));
										_player.getInventory().setChanged();
									} else if (_entity instanceof LivingEntity _living) {
										_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.CONCHED_CHAINMAIL_ARMOR_BOOTS.get()));
									}
								}
							}
						} else if (armorenchanted == true) {
						...
						if (armorenchanted == true) {
							{
								...
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(0,
											(EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(SuperiorsmithingModItems.REINFORCED_DIAMOND_ARMOR_BOOTS.get()), Mth.nextInt(RandomSource.create(), 20, 30),
													(true)
															? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
															: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream())));
									_player.getInventory().setChanged();
						...
						} else {
							{
								Entity _entity = entity;
								if (_entity instanceof Player _player) {
									_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_BOOTS.get()));
									_player.getInventory().setChanged();
								} else if (_entity instanceof LivingEntity _living) {
									_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.CONCHED_DIAMOND_ARMOR_BOOTS.get()));
								}
							}
						}
					} else if (armorenchanted == true) {
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.TRIDENT) {
				SuperiorsmithingMod.queueServerWork(2, () -> {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								"/data merge entity @e[type=drowned, sort=nearest, limit=1] {HandDropChances:[1f],ArmorDropChances:[0.3f,0.2f,0.2f,0.3f]}");
				...
				SuperiorsmithingMod.queueServerWork(2, () -> {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								("/data merge entity @e[type=drowned, sort=nearest, limit=1] {HandDropChances:["
