...
public class SculkEchoingProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:leather_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_LEATHER_ARMOR_HELMET.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_LEATHER_ARMOR_CHESTPLATE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_LEATHER_ARMOR_LEGGINGS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_LEATHER_ARMOR_BOOTS.get());
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:chainmail_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_CHAINMAIL_ARMOR_HELMET.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_CHAINMAIL_ARMOR_CHESTPLATE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_CHAINMAIL_ARMOR_LEGGINGS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_CHAINMAIL_ARMOR_BOOTS.get());
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:iron_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_ARMOR_HELMET.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_ARMOR_CHESTPLATE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_ARMOR_LEGGINGS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_ARMOR_BOOTS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_SWORD.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_SHOVEL.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_PICKAXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_AXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_IRON_HOE.get());
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:golden_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_ARMOR_HELMET.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_ARMOR_CHESTPLATE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_ARMOR_LEGGINGS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_ARMOR_BOOTS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_SWORD.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_SHOVEL.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_PICKAXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_AXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_GOLDEN_HOE.get());
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:diamond_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_ARMOR_HELMET.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_ARMOR_CHESTPLATE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_ARMOR_LEGGINGS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_ARMOR_BOOTS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_SWORD.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_SHOVEL.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_PICKAXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_AXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_DIAMOND_HOE.get());
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:netherite_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_ARMOR_HELMET.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_ARMOR_CHESTPLATE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_ARMOR_LEGGINGS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_ARMOR_BOOTS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_SWORD.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_SHOVEL.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_PICKAXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_AXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_NETHERITE_HOE.get());
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:turtle_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_TURTLE_SHELL_HELMET.get());
		...
		if (target.is(ItemTags.create(ResourceLocation.parse("forge:ethereal_helmets")))) {
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_ARMOR_HELMET.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_ARMOR_CHESTPLATE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_ARMOR_LEGGINGS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_ARMOR_BOOTS.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_SWORD.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_SHOVEL.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_PICK.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_AXE.get());
			...
			product = new ItemStack(SuperiorsmithingModItems.ECHOING_ETHEREAL_HOE.get());
