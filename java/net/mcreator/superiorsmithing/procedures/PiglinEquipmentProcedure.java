...
@EventBusSubscriber
public class PiglinEquipmentProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double rarity = 0;
		if (!(entity instanceof PiglinBrute) && (entity instanceof Piglin || entity instanceof ZombifiedPiglin) && !(entity.getDisplayName().getString()).equals("static")) {
			weapon = false;
			armor = false;
			helmet = false;
			boots = false;
					...
					if (weaponmodified == true) {
						if (weaponenchanted == true) {
							if (type == 0) {
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(Items.CROSSBOW), Mth.nextInt(RandomSource.create(), 10, 20),
											(false)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
					...
					if (weaponmodified == true) {
						if (weaponenchanted == true) {
							if (type == 0) {
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = (EnchantmentHelper.enchantItem(world.getRandom(), new ItemStack(Items.CROSSBOW), Mth.nextInt(RandomSource.create(), 20, 30),
											(true)
													? world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).holders().map(reference -> (Holder<Enchantment>) reference)
													: world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getTag(EnchantmentTags.IN_ENCHANTING_TABLE).get().stream()))
											.copy();
					...
					if (type == 0) {
						{
							...
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_HELMET.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_HELMET.get()));
							}
						}
					} else if (type == 1) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_HELMET.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_HELMET.get()));
							}
						}
					} else if (type == 2) {
						{
					...
					} else if (type == 3) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(3, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_HELMET.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_HELMET.get()));
							}
						}
					}
				} else if (rarity == 1) {
					...
					if (type == 0) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_CHESTPLATE.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_CHESTPLATE.get()));
							}
						}
					} else if (type == 1) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_CHESTPLATE.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_CHESTPLATE.get()));
							}
						}
					} else if (type == 2) {
						{
					...
					} else if (type == 3) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(2, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_CHESTPLATE.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_CHESTPLATE.get()));
							}
						}
					}
				} else if (rarity == 1) {
					...
					if (type == 0) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_LEGGINGS.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_LEGGINGS.get()));
							}
						}
					} else if (type == 1) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_LEGGINGS.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_LEGGINGS.get()));
							}
						}
					} else if (type == 2) {
						{
					...
					} else if (type == 3) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(1, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_LEGGINGS.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_LEGGINGS.get()));
							}
						}
					}
				} else if (rarity == 1) {
					...
					if (type == 0) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_BOOTS.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.CYAN_LEATHER_ARMOR_BOOTS.get()));
							}
						}
					} else if (type == 1) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_BOOTS.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.RED_LEATHER_ARMOR_BOOTS.get()));
							}
						}
					} else if (type == 2) {
						{
					...
					} else if (type == 3) {
						{
							Entity _entity = entity;
							if (_entity instanceof Player _player) {
								_player.getInventory().armor.set(0, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_BOOTS.get()));
								_player.getInventory().setChanged();
							} else if (_entity instanceof LivingEntity _living) {
								_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(SuperiorsmithingModItems.GRAY_LEATHER_ARMOR_BOOTS.get()));
							}
						}
					}
				} else if (rarity == 1) {
			...
			SuperiorsmithingMod.queueServerWork(2, () -> {
				if (world instanceof ServerLevel _level)
					_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
							("/data merge entity @e[type=piglin, sort=nearest, limit=1] {HandDropChances:["
